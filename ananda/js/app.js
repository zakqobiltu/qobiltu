...
const play = (btn) => {
    ...
    if (!isPlay) {
        ...
        audio.play();
        btn.innerHTML = '<i class="ai-pause" style="font-size: 22px; color: WHITE"></i>';
    } else {
        btn.setAttribute('data-status', 'false');
        audio.pause();
        btn.innerHTML = '<i class="ai-play" style="font-size: 22px; color: WHITE"></i>';
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   const scriptURL = 'https://script.google.com/macros/s/AKfycbzpWUU6aBSTvAqHACXQuuC3dS3Upen9m6BJ0Kjs_l4K0KwXacGB7she4AhAOQt63ncK/exec'
